...
# UhHu! CORE — Contrato Inicial (DEV)

> **Contrato DEV v0.1 — rascunho para validação.**
>
> Cópia operacional limpa do contrato canônico em
> `~/vault/Projetos/UhHu/UhHu_CORE_Contrato_Inicial.md`. Esta cópia existe para
> consumo direto do desenvolvimento. O vault é a fonte da verdade; após qualquer
> decisão validada, sincronizar este arquivo.
